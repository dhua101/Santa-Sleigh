    ...
    <div class="w3-top">
        <ul class="w3-navbar w3-white w3-left-align">
            ...
            <form action="searching.php" method="POST">
                <input type="text" name="search" placeholder="search item" id='search-text-input' style="width:425px margin-top:42px;">
                <div id='button-holder'>
                    <img src='https://d30y9cdsu7xlg0.cloudfront.net/png/6983-200.png' />
                </div>
            </form></a></li>
        ...
        <div class="w3-panel">
            <div class="w3-row">
                <div class="w3-quarter">
                    <div class="w3-card-4">
                        <div class="w3-panel w3-center">
                            <img src="http://localhost/Santa%20Sleigh/merrychristmas.jpg">

                            <p name="item1">Merry Christmas Gift Card</p>
                            <?php
                                ...
                                $sqlstock = "SELECT stock_quantity FROM stockgc_tbl WHERE stock_id='1'";
                            ...
                            ?>
                            <form action="cartcard.php"method="get">
                                Gift Card Value:
                                <select name="value">
                                    <option value="10" name ="ten1" id="ten1">$10</option>
                                    <option value="20" name ="twenty1" id="twenty1">$20</option>
                                    <option value="25" name ="twentyfive1" id="twentyfive1">$25</option>
                                    <option value="50" name ="fifty1" id="fifty1">$50</option>
                                    <option value="100" name ="hundred1" id="hundred1">$100</option>
                                </select><br>
                                Quantity: 
                ...
                <div class="w3-quarter">
                    <div class="w3-card-4">
                        <div class="w3-panel w3-center">
                            <img src="http://localhost/Santa%20Sleigh/happyholiday.jpg">

                            <p name="item2">Happy Holidays Gift Card</p>
                            <?php
                                error_reporting(E_ALL ^ E_DEPRECATED);
                                $stock = '';
                            ...
                            <form action="cartcard.php"method="get">
                                Gift Card Value:
                                <select name="value">
                                    <option value="10" name ="ten2" id="ten">$10</option>
                                    <option value="20" name ="twenty2" id="twenty2">$20</option>
                                    <option value="25" name ="twentyfive2" id="twentyfive2">$25</option>
                                    <option value="50" name ="fifty2" id="fifty2">$50</option>
                                    <option value="100" name ="hundred2" id="hundred2">$100</option>
                                </select><br>
                                Quantity: 
