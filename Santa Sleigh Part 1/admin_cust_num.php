    ...
    <div class="w3-main" style="margin-top:100px;">
        <div class="w3-panel">
            <?php
                ...
                echo "<h3><b><center>From first to latest customer</center></b></h3>";

                $sqlsort1 = "SELECT * FROM sales_tbl ORDER BY customer_num ASC";
                ...
                echo "<h3><b><center>From latest customer to first customer</center></b></h3>";

                $sqlsort2 = "SELECT * FROM sales_tbl ORDER BY customer_num DESC";
