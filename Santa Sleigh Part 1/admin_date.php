    ...
    <div class="w3-main" style="margin-top:100px;">
        <div class="w3-panel">
            <?php
                ...
                echo "<h3><b><center>First to Latest Date Purchased</center></b></h3>";

                $sqlsort1 = "SELECT * FROM sales_tbl ORDER BY date_purchase ASC";
                ...
                echo "<h3><b><center>Latest to First Date Purchased</center></b></h3>";

                $sqlsort2 = "SELECT * FROM sales_tbl ORDER BY date_purchase DESC";
