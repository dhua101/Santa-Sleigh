    ...
    <div class="w3-main" style="margin-top:100px;">
        <div class="w3-panel">
            <?php
                ...
                echo "<h3><b><center>Lowest to Highest Amout of Items</center></b></h3>";

                $sqlsort1 = "SELECT * FROM sales_tbl ORDER BY total_items ASC";
                ...
                echo "<h3><b><center>Highest to Lowest Amout of Items</center></b></h3>";

                $sqlsort2 = "SELECT * FROM sales_tbl ORDER BY total_items DESC";
