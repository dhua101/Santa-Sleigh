    ...
    <div class="w3-main" style="margin-top:100px;">
        <div class="w3-panel">
            <div class="w3-threequarter border">
                ...
                <form action="informationmastercard.php" method="get">
                    <div class="w3-half">
                        First Name:<br>
                    ...
                    <div class="w3-half">
                        Postal/Zip Code:<br>
                        <input type="text" name="postalzip" id="postalzip">
                    </div>
                    <br>
                    <div class="w3-full">
                        Email Address<br>
                    ...
                    for updates, special offers, and status
                    <br>
                    <div class="w3-half">
                        Telephone:<br>
                    ...
                    for concerns and questions with your order.
                    <br><br>
