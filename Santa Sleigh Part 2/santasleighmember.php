    ...
    <div class="w3-main topmargin" method="POST">
        <div class="container w3-center">
            <div class="slider_wrapper">
                <ul id="image_slider">
                    <li><img src="http://localhost/Santa%20Sleigh/sale.jpg"></li>
                    <li><img src="http://localhost/Santa%20Sleigh/sales2.jpg"></li>
                    <li><img src="http://localhost/Santa%20Sleigh/sale3.jpg"></li>
                    <li><img src="http://localhost/Santa%20Sleigh/sale4.jpg"></li>
                </ul>
            </div>
        </div>
                ...
                <div class="w3-row">
                    <div class="w3-card-8">
                        ...
                        <div class="w3-twothird w3-border w3-center">
                            ...
                            <a class="w3-btn w3-theme-d3" href="giftgivingmember.php">Learn More</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="w3-row">
                    <div class="w3-card-8">
                        ...
                        <div class="w3-twothird w3-border w3-center">
                            ...
                            <a class="w3-btn w3-theme-d3" href="everyonegiftsmember.php">Learn More</a>
                        </div>
                    </div>
                </div>
            </div>
